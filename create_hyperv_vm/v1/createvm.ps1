...
# VM Path
$VMPath         = Read-Host "Enter path to store VM"

# VM Generation (1 or 2)
$Gen            = 2

# Processor Number
$ProcessorCount = Read-Host "Enter virtual CPU count"
...
$Drive       | Add-Member -MemberType NoteProperty -Name Size -Value 50GB
...
$Drive       | Add-Member -MemberType NoteProperty -Name Path -Value $($VMPath + "\" + $VMName)
$Drive       | Add-Member -MemberType NoteProperty -Name Size -Value 100GB
$Drive       | Add-Member -MemberType NoteProperty -Name Type -Value Dynamic
$ExtraDrive += $Drive
...
$Drive       | Add-Member -MemberType NoteProperty -Name Path -Value $($VMPath + "\" + $VMName)
$Drive       | Add-Member -MemberType NoteProperty -Name Size -Value 200GB
$Drive       | Add-Member -MemberType NoteProperty -Name Type -Value Dynamic
$ExtraDrive += $Drive
