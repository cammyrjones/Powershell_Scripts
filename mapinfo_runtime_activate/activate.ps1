...
$logfile = "c:\temp\mapinforlog-$date.txt"
...
$mapinfor = "C:\Program Files (x86)\MapInfo\Runtime\mapinfor.exe"
#define the file to use a flag to keep a track of where this software has been activated
$flagfile = "\\filesvr1\mdt_share$\MapInfo\Runtime_deployments\$($Env:COMPUTERNAME).txt"
